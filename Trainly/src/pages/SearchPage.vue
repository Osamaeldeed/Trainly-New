        ...
        <div v-else>
          ...
          <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            >
              ...
              />
              <div class="p-4">
                <h3 class="font-semibold text-lg truncate dark:text-gray-300">
                  {{ trainer.firstName }} {{ trainer.lastName }}
                </h3>
                <p class="text-[#00B0FF] dark:text-gray-300 text-sm font-medium mb-2 capitalize">
                  {{ trainer.sport || "N/A" }}
                </p>
                ...
                <div class="flex items-center text-sm text-gray-700 mb-2" v-if="trainer.city">
                  ...
                  <span class="capitalize dark:text-gray-300"

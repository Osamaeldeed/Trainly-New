        ...
        >
          <div class="p-6 border-b">
            <button
              ...
              class="absolute top-4 right-4 cursor-pointer text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full p-2 transition"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6"
          ...
          <div class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
            <div>
              <label class="block text-sm font-semibold dark:text-gray-300 text-gray-700 mb-2"
                >Your Name *</label
              >
              <input
            ...
            <div>
              ...
              <div class="flex items-center gap-2">
                <select
                  ...
                  class="p-3 border border-gray-300 cursor-pointer rounded-lg text-black dark:text-white bg-white dark:bg-[#3B3B3B] focus:ring-2 outline-none transition"
                >
          ...
          <div class="p-6 border-t bg-gray-50 dark:bg-[#3B3B3B] flex justify-end gap-3">
            <button
              @click="closeAddReview"
              class="px-6 py-2.5 border dark:text-white border-gray-300 rounded-lg hover:bg-gray-100 transition font-medium cursor-pointer"

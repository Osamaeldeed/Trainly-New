        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div>
            <button
              ...
              :class="[
                'w-full p-4 flex items-start gap-3 hover:bg-gray-50 hover:dark:bg-black transition-colors border-b border-gray-100 cursor-pointer',
              ...
              <div class="flex-1 min-w-0 text-left">
                <div class="flex items-center justify-between mb-1">
                  ...
                  <span
                    ...
                    class="text-xs dark:text-gray-400 text-gray-500 flex-shrink-0 ml-2"
                  >

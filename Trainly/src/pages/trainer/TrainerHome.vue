      ...
      >
        ...
        <div v-if="plans.length" class="space-y-3">
          <div
            v-for="plan in plans"
            :key="plan.id"
            class="border border-gray-200 rounded-xl p-4 flex justify-between items-center hover:bg-gray-50 transition hover:dark:bg-[#4b4b4b]"
          >
            <div>
        ...
        <p v-else class="text-gray-400  dark:text-white text-sm text-center mt-4">
          No plans yet.
        </p>
      </div>

<template>
  <div>
    <!-- Welcome Header -->
    <div
      class="w-full relative mb-10 rounded-2xl shadow-md p-6 flex items-center justify-between overflow-hidden bg-linear-to-r from-[#D9EEFF] to-[#AEE2FF] dark:from-[#3B3B3B] dark:to-[#3B3B3B]"
    >
      ...
      <div class="flex items-center gap-5 relative z-10">
        ...
        <div>
          ...
          <p class="text-sm dark:text-white text-gray-600 mt-1">
    ...
    <section class="w-full flex flex-col gap-10">
      ...
      >
        <div class="flex items-center gap-3 mb-6 self-start">
          ...
          >
            <img src="../../assets/images/page1.png" alt="" class="w-5 h-5" />
          </div>
          <div>
        ...
        <div class="w-full space-y-10">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mx-15">
            <div>
              <label
                for="first-name"
                class="block text-sm dark:text-white font-medium text-gray-900"
                >First Name</label
              >
              <input
                id="first-name"
            ...
            <div>
              <label for="last-name" class="block text-sm font-medium dark:text-white text-gray-900"
                >Last Name</label
              >
              <input
                id="last-name"
            ...
            <div>
              <label for="email" class="block text-sm dark:text-white font-medium text-gray-900"
                >Email</label
              >
              <input
                id="email"
            ...
            <div>
              <label for="gender" class="block text-sm dark:text-white font-medium text-gray-900"
                >Gender</label
              >
              <select
                id="gender"
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mx-15">
            ...
            <div>
              <label for="country" class="block text-sm dark:text-white font-medium text-gray-900"
                >Country</label
              >
              <input
                id="country"
            ...
            <div>
              <label for="birthday" class="block text-sm dark:text-white font-medium text-gray-900"
                >Birthday</label
              >
              <input
                id="birthday"

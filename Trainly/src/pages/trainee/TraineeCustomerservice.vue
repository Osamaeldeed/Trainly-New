<template>
  <div>
    ...
    >
      <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4">
        ...
        <div class="text-center sm:text-left">
          ...
          <p class="text-sm dark:text-white text-gray-500">Need help? We're here for you.</p>
        </div>
      </div>
    </div>
    ...
    <section>
      <h2 class="text-xl sm:text-2xl font-semibold dark:text-white text-gray-800 mb-1">
        Customer Services
      </h2>
      <p class="text-gray-500 dark:text-white mb-6 text-sm sm:text-base">We're here to help you.</p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-[#3B3B3B] p-6 rounded-2xl shadow-sm">
          ...
          <form class="space-y-4" @submit.prevent="sendReport">
            ...
            <button
              type="submit"
              class="w-full bg-[#00B0FF] cursor-pointer dark:text-white text-white py-2 rounded-lg font-medium hover:bg-blue-600 transition"
            >
              Send Message
            </button>
          </form>
        ...
        <div class="flex flex-col gap-6 lg:col-span-2">
          <div class="bg-white dark:bg-[#3B3B3B] p-6 rounded-2xl shadow-md flex items-start gap-4">
            ...
            />
            <div>
              <h4 class="text-lg font-semibold dark:text-white text-gray-800 mb-1">
                Email Support
              </h4>
              <p class="text-sm text-gray-500 dark:text-white mb-1">Get help via email</p>
              <a
    ...
    <section class="mt-10">
      <div class="bg-white dark:bg-[#3B3B3B] p-6 rounded-2xl shadow-sm flex flex-col gap-4">
        <h3 class="text-lg sm:text-xl font-semibold dark:text-white text-gray-800">
        ...
        <div class="flex flex-col gap-3">
          <div class="p-4 bg-[#FCFBFB] dark:bg-[#3B3B3B] rounded-2xl shadow-md">
            <h4 class="font-medium dark:text-white text-gray-800">
              How do I book a session with my trainer?
            </h4>
          ...
          <div class="p-4 bg-[#FCFBFB] dark:bg-[#3B3B3B] rounded-2xl shadow-md">
            <h4 class="font-medium dark:text-white text-gray-800">
              How do I contact my trainer directly?
            </h4>
            <p class="text-sm dark:text-gray-300 text-gray-500 mt-1">
              Use the "Inbox" section to send direct messages to your trainer. They typically
    ...
    >
      ...
      >
        ...
        <p class="text-gray-700 mb-4 dark:text-white text-base sm:text-lg leading-relaxed">
          Your report has been sent successfully. <br />
          The admin will review it soon.
        </p>
        <button
          @click="showPopup = false"
          class="bg-[#00B0FF] dark:bg-[#3B3B3B] text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition"
        >
          OK
        </button>
      </div>

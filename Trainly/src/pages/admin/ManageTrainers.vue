              ...
              <teleport to="body">
                ...
                >
                  <router-link to="/myprofile">
                    <button
                      class="block w-full text-left px-4 py-2 cursor-pointer text-gray-700 hover:bg-gray-100"
                    >
                      View Account
                    </button>
                  </router-link>
                  ...
                  <button
                    ...
                    class="block w-full text-left px-4 py-2 cursor-pointer text-red-600 hover:bg-gray-100"
                  >
                    Delete
                  </button>
                </div>

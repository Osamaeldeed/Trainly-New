          ...
          >
            <button
              @click="
                ...
                showUserMenu = false;
              "
              class="w-full text-left px-4 py-2 text-[#333] dark:text-white hover:bg-gray-100 transition cursor-pointer"
            >
              My Dashboard
            </button>
            <button
...
export default {
  ...
  methods: {
    ...
    handleLogout() {
      // showLogoutModal is provided by setup() and merged onto the component instance

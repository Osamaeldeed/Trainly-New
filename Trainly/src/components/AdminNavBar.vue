  ...
  >
    ...
    <div class="hidden md:block relative">
      ...
      >
        ...
        >
          <button
            @click="$router.push('/admin/overview'); showUserMenu = false"
    ...
    <transition name="fade">
      ...
      >
        ...
        <router-link to="/admin/overview" class="nav-link" @click="isOpen = false">
          Overview
        </router-link>
        <router-link to="/admin/managetrainers" class="nav-link" @click="isOpen = false">
          Trainers
        </router-link>
        <router-link to="/admin/managetrainees" class="nav-link" @click="isOpen = false">
          Trainees
        </router-link>
        <router-link to="/admin/bookings" class="nav-link" @click="isOpen = false">
          Bookings
        </router-link>
        ...
        <div class="flex flex-col gap-2 w-[80%] items-center">
          ...
          >
            <div v-if="showUserMenu" class="flex flex-col w-full bg-white rounded-lg shadow-md">
              <!-- ✅ Dashboard Button -->
              <button
                @click="$router.push('/admin/overview'); isOpen = false; showUserMenu = false"
